...
public://functions
    ...
    virtual bool isEqual(const TuiPointer<TuiRef>& other) {return other && other->type() == Tui_ref_type_NUMBER && Tui::castPointer<TuiNumber>(other)->value == value;}
...
public://functions
    ...
    virtual bool boolValue() {return true;}
    virtual double getNumberValue() {return value;}
    virtual bool isEqual(const TuiPointer<TuiRef>& other) {return other && (
...
public://functions
    ...
    static TuiPointer<TuiBool> initWithHumanReadableString(const char* str, char** endptr, const TuiPointer<TuiTable>& parent, TuiDebugInfo* debugInfo) {
...
public://functions
    ...
    static TuiPointer<TuiVec2> initWithHumanReadableString(const char* str, char** endptr, const TuiPointer<TuiTable>& parent, TuiDebugInfo* debugInfo) {
        const char* s = tuiSkipToNextChar(str, debugInfo);
        ...
        if(*s == 'v' && *(s + 1) == 'e' && *(s + 2) == 'c' && *(s + 3) == '2' && *(s + 4) == '(')
        {
            ...
            for(int i = 0; i < 2; i++)
            {
                TuiPointer<TuiRef> loadedValue = TuiRef::loadExpression(s, endptr, nullptr, nullptr, parent, debugInfo);
    ...
    virtual bool boolValue() {return true;}
    virtual bool isEqual(const TuiPointer<TuiRef>& other) {return other && other->type() == Tui_ref_type_VEC2 && Tui::castPointer<TuiVec2>(other)->value == value;}
...
public://functions
    ...
    static TuiPointer<TuiVec3> initWithHumanReadableString(const char* str, char** endptr, const TuiPointer<TuiTable>& parent, TuiDebugInfo* debugInfo) {
        const char* s = tuiSkipToNextChar(str, debugInfo);
    ...
    virtual bool boolValue() {return true;}
    virtual bool isEqual(const TuiPointer<TuiRef>& other) {return other && other->type() == Tui_ref_type_VEC3 && Tui::castPointer<TuiVec3>(other)->value == value;}
...
public://functions
    ...
    static TuiPointer<TuiVec4> initWithHumanReadableString(const char* str, char** endptr, const TuiPointer<TuiTable>& parent, TuiDebugInfo* debugInfo) {
        const char* s = tuiSkipToNextChar(str, debugInfo);
    ...
    virtual bool boolValue() {return true;}
    virtual bool isEqual(const TuiPointer<TuiRef>& other) {return other && other->type() == Tui_ref_type_VEC4 && Tui::castPointer<TuiVec4>(other)->value == value;}
...
public://functions
    ...
    static TuiPointer<TuiMat3> initWithHumanReadableString(const char* str, char** endptr, const TuiPointer<TuiTable>& parent, TuiDebugInfo* debugInfo) {
        const char* s = tuiSkipToNextChar(str, debugInfo);
    ...
    virtual bool boolValue() {return true;}
    virtual bool isEqual(const TuiPointer<TuiRef>& other) {return other && other->type() == Tui_ref_type_MAT3 && Tui::castPointer<TuiMat3>(other)->value == value;}
